controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    userInput = game.askForString("Are you having trouble deciding what to eat?")
    fastFoodOptions = randint(0, 19)
})
let userInput = ""
let fastFoodOptions = 0
game.showLongText("Welcome to the random fast food spinner! Here you can decide where you'd like to eat!", DialogLayout.Center)
